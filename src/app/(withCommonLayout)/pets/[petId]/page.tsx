    ...
    <Container maxWidth="lg" sx={{ my: 4 }}>
      ...
      >
        ...
        <Box sx={{
          ...
          <Button fullWidth LinkComponent={Link} href="/dashboard/user/add-adoption" sx={{ mt: 4 }}>
            Apply to Adopt
          </Button>
        </Box>
      </Box>
      ...
      <Section title="Favorites Things">
        <Box sx={{ display: "flex", gap: 2}}>
          <Typography variant="body2"><GradeIcon fontSize="small"/> Belly Rubs</Typography>
          <Typography variant="body2"><GradeIcon fontSize="small"/> Lead Walks</Typography>
          <Typography variant="body2"><GradeIcon fontSize="small"/> Playing with Toys</Typography>
          <Typography variant="body2"><GradeIcon fontSize="small"/> Cuddles on Sofa</Typography>
        </Box>
      </Section>
      ...
      <Section title="Home Requirements">
        <Box sx={{ display: "flex", gap: 4 }}>
          <Box>
            <Typography variant="body2" fontWeight={600}>Minimum age of children?</Typography>
            <Typography variant="body2" >8</Typography>
          </Box>
          <Box>
            <Typography variant="body2"fontWeight={600}>Can they live with dogs?</Typography>
            <Typography variant="body2">Can live with a dog</Typography>
          </Box>
          <Box>
            <Typography variant="body2"fontWeight={600}>Can they live with cats?</Typography>
