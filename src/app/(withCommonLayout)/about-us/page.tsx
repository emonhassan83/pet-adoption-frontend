...
const servicesData = [
  ...
  },
  {
    ...
    learn_more_link: "/care",
  },
  // {
  //   image: assets.images.about_card_img3,
  ...
  const leadershipData = [
    {
      ...
      bio:
        "With over 20 years of experience in animal welfare, Susanne leads our organization with a passion for making a difference. Under her leadership, we've expanded our reach and impact nationwide.",
    ...
    },
    {
      ...
      bio:
        "Jennifer is a strategic thinker with a heart for animals. She has spearheaded numerous successful partnerships that have brought significant resources to our cause.",
    ...
    },
    {
      ...
      bio:
        "As a business leader and philanthropist, Daymond brings a wealth of experience in strategic growth and innovation. His contributions have been instrumental in our organization's success.",
    ...
    },
    {
      ...
      bio:
        "Dana's expertise in marketing and branding has helped us connect with a broader audience, raising awareness about our mission and the importance of pet adoption.",
